...
const scrollToBottom = () => { nextTick(() => { if (!listRef.value) return; listRef.value.scrollTop = listRef.value.scrollHeight }) }
...
html[data-theme='dark'] .copy-btn, html[data-theme='dark'] .citation-panel, html[data-theme='dark'] .citation-card { background: #1b2027; color: #e7ecf3; border-color: #2c323a; }
